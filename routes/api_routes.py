    ...
    if is_tft:
        ...
        if game_match_id:
            ...
            if full_game:
                ...
                print(f"⚠️ [TFT] 通过 match_id 获取失败，使用历史记录中的数据")
                game = game_summary
        else:
            # 如果没有 match_id，使用 history 中的数据
            print(f"⚠️ [TFT] 无 match_id，使用历史记录中的数据")
            game = game_summary
        ...
        if game_match_id:
            ...
            if full_game:
                ...
                # 如果通过 match_id 获取失败，降级使用 history 中的数据
                print(f"⚠️ 通过 match_id 获取失败，使用历史记录中的数据")
                game = game_summary
        else:
            # 如果没有 match_id，使用 history 中的数据
            print(f"⚠️ 无 match_id，使用历史记录中的数据")
            game = game_summary
